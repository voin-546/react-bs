export default function Footer () {
    return <footer className="bg-dark py-5 position-relative z-2">
        <div className="container">
            <div className="row justify-content-between text-md-center text-sm-center text-lg-start text-center">
                <div className="col-lg-3 col-sm-12 d-flex flex-column mb-5">
                ...
                <div className="col-lg-2 mb-5">
                    ...
                    <div className="social-links d-flex gap-1 justify-content-md-center justify-content-center justify-content-lg-start">
                        <a href="/">
